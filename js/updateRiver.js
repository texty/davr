...
var indicatorNames = [
    ...
    {key: "Кисень.розчинений.МгО2.дм3", abr: "Кис. розч", printName: "Кисень розчинений", description: "Його використовує риба для дихання. Якщо його вміст подобає нижче критичного показника, риба може вимирати. Рівень кисню знижується у забрудненій воді. Частина кисню використовується на розкладання сторонніх речовин"},
